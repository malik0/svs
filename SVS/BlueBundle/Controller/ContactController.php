...
use SVS\BlueBundle\Entity\Contact;
use SVS\BlueBundle\Form\ContactType;
...
class ContactController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SVSBlueBundle:Contact')->findAll();
     ...
     * @Method("POST")
     * @Template("SVSBlueBundle:Contact:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SVSBlueBundle:Contact')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("SVSBlueBundle:Contact:edit.html.twig")
     */
